...
// Generates a tuple of numbers from Start to End
type ZeroToN<N extends number, Result extends number[] = []> = Result['length'] extends N ? Result[number] : ZeroToN<N, [...Result, Result['length']]>;
type Range<Start extends number, End extends number> = Exclude<ZeroToN<End>, ZeroToN<Start>>;
...
export type MaterialSymbolCodepoints = (typeof MaterialSymbolCodepointsArray)[number];

export type MaterialSymbolWeight =  Range<100, 701>;
export type MaterialSymbolGrade = Range<0, 226>; // -25 to 200
export type MaterialSymbolSize = Range<5, 999>; // 5 to 1200
...
// A list of all Material Symbols, ignore
const MaterialSymbolCodepointsArray = [
	'10k',
	'10mp',
	'11mp',
	'123',
